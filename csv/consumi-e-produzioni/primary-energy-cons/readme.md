...
This data package contains the data that powers the chart ["Primary energy consumption"](https://ourworldindata.org/grapher/primary-energy-cons?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 09, 2025.
