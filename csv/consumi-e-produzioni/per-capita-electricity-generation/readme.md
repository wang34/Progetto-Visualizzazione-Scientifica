# Per capita electricity generation - Data package

This data package contains the data that powers the chart ["Per capita electricity generation"](https://ourworldindata.org/grapher/per-capita-electricity-generation?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 09, 2025.
...
## Total electricity generation per person – Ember and Energy Institute
...
Source: Ember (2024), Energy Institute - Statistical Review of World Energy (2024), Population based on various sources (2023) – with major processing by Our World In Data
