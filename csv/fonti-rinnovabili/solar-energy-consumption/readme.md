...
This data package contains the data that powers the chart ["Solar power generation"](https://ourworldindata.org/grapher/solar-energy-consumption?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on February 09, 2025.
